...
//            FirebaseDatabase.getInstance().getReference().child(Constant.dbnode_comic)
        val reference = FirebaseDatabase.getInstance().getReference().child(Constant.dbnode_comic).orderByChild("sections").equalTo("coming")
